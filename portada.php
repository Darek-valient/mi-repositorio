...
try {
    ...
    $miConsulta = $miPDO->prepare('SELECT * FROM innovacion_registro WHERE fecha >= :fechaActual');
    $miConsulta->bindParam(':fechaActual', $fechaActual);
    $miConsulta->execute();
...
<body>
    <h1>LISTA DE PEDIDOS DEL AULA DE INNOVACIÓN</h1><br>
    <div class="centro-btn">
        <a href="lista.php" class="btn">Lista completa</a>
    </div>
